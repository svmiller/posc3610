...
```{r reed2000-tab1-mod1, eval=T, echo=F, fig.width=14, fig.height=8.5, warning=F, message=F}
library(dotwhisker)
tribble(
...
```{r reed2000-tab1-mod2, eval=T, echo=F, fig.width=14, fig.height=8.5, warning=F, message=F}
...
```{r reed2000-tab1-mod3, eval=T, echo=F, fig.width=14, fig.height=8.5, warning=F, message=F}
