...
Sims[[2]] %>%
  ...
  labs(y = "Mean Probability of Confrontation Escalation to Dyadic War (with 95% Intervals)",
       x = "",
       title = "The Probability of Dyadic War Between Joint Democracies is Fantastically Rare, Almost Zero",
...
### What Are These Jointly Democratic Wars?
...
- Franco-Siamese War (MIC#0196) even though Britain never actually fought France.
- India-Pakistan "Kargil War" (MIC#4007) even though Pakistan was reverting to a police state.
- Cyprus-Turkey 1974 conflict (MIC#1293) even though Turkey would soon have a coup.
