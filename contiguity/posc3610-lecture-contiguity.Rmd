...
modelsummary(list("Conf. Onset" = Mods[[1]], "Min. Fatalities" = Mods[[3]], 
             ...
             stars = TRUE)  %>%
  kable_styling(font_size = 8) %>%
  column_spec(c(2), color = c(rep("#00cc00", 4), "black")) %>%
  column_spec(c(3), color = c(rep("#00cc00", 2), rep("#cc0000", 2), "black")) %>%
  column_spec(c(4), color = c(rep("#00cc00", 2), rep("#cc0000", 2), "black")) %>%
  column_spec(c(5), color = c(rep("#cc0000", 4), "black"))
```
...
modelsummary(list("Conf. Onset" = Mods[[1]], "Min. Fatalities" = Mods[[3]], 
  ...
  column_spec(c(4), color = c(rep("#00cc00", 2), rep("#cc0000", 2), "black")) %>%
  column_spec(c(5), color = c(rep("#cc0000", 4), "black"),
              bold = c(rep(FALSE, 2), rep(TRUE, 2), FALSE))
